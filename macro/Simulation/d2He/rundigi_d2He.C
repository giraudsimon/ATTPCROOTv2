void rundigi_d2He
(TString mcFile = "attpcsim_d2He_test.root",//attpcsim_d2He_14O_07atm_100000.root
TString digiParFile = "../../../parameters/ATTPC.d2He.par",
TString mapParFile = "../../../scripts/Lookup20150611.xml",
TString parFile = "attpcpar_d2He_test.root")    //"attpcpar_d2He_test_10k.root")//attpcpar_d2He_14O_07atm_100000.root
//TString trigParFile = "../../../parameters/AT.trigger.par")
{
  ...
  fRun -> SetOutputFile("digi_test.root");
