                        ...
                        if(p_f.size()>0)
                        {
                                      ...
                                      if(L_mag>0)
                                      {
                                          ...
                                          if(d<mad){
                                            ...
                                            Double_t range_i = track->GetLinearRange(vertex_mean_off);
                                            Double_t range_j = track_f->GetLinearRange(vertex_mean_off);
                                            ...
                                            //---------------------------------------------------------------------------------------------
                                             ...
                                             if ( !CheckTrackID(track->GetTrackID(),&fTrackCand) ){
                                                ...
                                                PL.Range.first      = range_i;
                                                PL.Range.second     = range_j;
